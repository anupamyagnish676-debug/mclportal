  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm space-y-4">
      ...
      <div className="flex items-center gap-2 border-b border-gray-50 pb-3">
        ...
        <div>
          <h2 className="text-sm font-bold text-gray-900">Google Authenticator Two-Factor Authentication (2FA)</h2>
      ...
      <div className={`flex items-center gap-2 px-3 py-2 rounded-xl text-xs font-semibold w-fit ${
        ...
        {isEnrolled
          ? <><CheckCircle2 className="w-3.5 h-3.5" /> Google Authenticator 2FA is Active</>
          ...
          {factors.map(f => (
            <div key={f.id} className="flex items-center justify-between p-3 bg-emerald-50/50 rounded-xl border border-emerald-100">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="text-xs font-semibold text-gray-800">{f.friendly_name || 'Google Authenticator App'}</p>
