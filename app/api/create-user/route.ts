    ...
    if (role === 'student' || role === 'mentor' || role === 'employee' || role === 'admin' || role === 'finance') {
      try {
        if (process.env.GMAIL_USER && process.env.GMAIL_PASS) {
          ...
          const isPaidIntern = isStudent && internship_type === 'paid'
          const subject = isStudent
            ? isPaidIntern
              ? 'Internship Joining / Reporting Letter (Paid Internship) - Mahanadi Coalfields Limited'
            ...
            : `
              <div style="font-family: Arial, sans-serif; max-width: 640px; margin: 0 auto; border: 1px solid #e5e7eb; border-radius: 12px; overflow: hidden;">
                ...
                <div style="padding: 32px;">
                  ...
                  <p>You can access the portal via: <a href="${portalUrl}" style="color: #166534; text-decoration: underline; font-weight: 600;">${portalUrl}</a></p>
