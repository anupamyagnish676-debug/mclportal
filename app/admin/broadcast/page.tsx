...
import {
  ...
  Users, ChevronDown, RefreshCw, Eye, EyeOff
} from 'lucide-react'
...
export default function BroadcastEmailPage() {
  ...
  function toggleRole(role: string) {
    if (role === 'all') {
      ...
      const next = selectedRoles.filter(r => r !== 'all').includes(role)
  ...
  function toggleArea(area: string) {
    if (area === 'all') {
      ...
      const next = selectedAreas.filter(a => a !== 'all').includes(area)
        ? selectedAreas.filter(a => a !== area && a !== 'all')
        : [...selectedAreas.filter(a => a !== 'all'), area]
  ...
  return (
    <div className="max-w-3xl space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-500 text-sm">Write a custom message and send it to selected users</p>
      </div>
              ...
              <div className="border border-gray-100 rounded-xl overflow-hidden">
                ...
                <div className="p-4 space-y-3">
                  <div className="flex items-center gap-2 text-xs text-gray-500">
                    <span className="font-semibold w-14">From:</span>
                    <span>MCL Internship Portal &lt;{process.env.NEXT_PUBLIC_GMAIL_USER || 'no-reply@mcl.gov.in'}&gt;</span>
                  </div>
                  <div className="flex items-center gap-2 text-xs text-gray-500">
                  ...
                  <div className="border-t border-gray-100 pt-3">
                    ...
                    <div className="border border-t-0 border-gray-100 rounded-b-lg px-4 py-3 text-xs text-gray-600 space-y-2">
                      <p>Dear <strong>Rahul Sharma</strong> <span className="text-gray-400">(Intern / Trainee — Talcher Area)</span>,</p>
