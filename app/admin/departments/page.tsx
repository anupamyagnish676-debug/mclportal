...
export default function AdminDepartmentsPage() {
  ...
  async function handleToggleAreaDepartment(deptName: string, currentStatus: boolean) {
    setError('')
    setSuccess('')
    const targetArea = selectedArea || profile?.area || 'Headquarters'
